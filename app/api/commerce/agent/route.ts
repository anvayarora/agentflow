...
export async function POST(request: Request) {
  try {
    ...
    const result = await runStorefrontAgent({ context, sessionId: session.id, message: body.message, salespersonProfileId: body.salespersonProfileId, language: body.language, storefrontContext: body.storefrontContext });
