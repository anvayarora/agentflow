...
export async function POST(request: Request) {
  ...
  try {
    ...
    const result = await runVoiceTurn({ context, sessionId: session.id, message: body.message, salespersonProfileId: body.salespersonProfileId, language: body.language, voiceEnabled: body.voiceEnabled, inputMode: body.inputMode, storefrontContext: body.storefrontContext });
