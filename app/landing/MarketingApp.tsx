  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-inner">
        ...
        <div className="footer-column"><b>RESOURCES</b><a href="/merchant/onboarding">Docs</a><a href="#guides">Guides</a><a href="#templates">Templates</a><a href="#case-studies">Case Studies</a><a href="#help">Help Center</a></div>
