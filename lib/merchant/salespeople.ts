...
export async function getSalespersonStats(context: TrustedRequestContext) {
  ...
  const verifiedLines = await getCommerceRepository().listVerifiedTransactionLines(context);
